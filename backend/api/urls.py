...
from . views import DocumentSectionAPIView, Endpoints, MyTokenObtainPairView, DocumentsView, DocumentView, SubmitDocumentView
...
urlpatterns = [
    ...
    path('document/<int:id>', DocumentView.as_view(), name='get_document'),
